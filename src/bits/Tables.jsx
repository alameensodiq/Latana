...
import { ReactComponent as Check } from "../assets/latanacheck.svg";
import { ReactComponent as Arr } from "../assets/downarr.svg";
import { ReactComponent as Eye } from "../assets/latanaeye.svg";
import { ReactComponent as Download } from "../assets/latanadownload.svg";
            ...
            >
              ...
              <TableBody>
                <StyledTableRow>
                  ...
                  <StyledTableCell style={{ width: "15%" }}>
                    <button className="activer-button">
                      <div className="activer">Success</div>
                    </button>
                    {/* (
                        <button className="inactive-button">
                          <div className="inactive">
                ...
                <StyledTableRow>
                  ...
                  <StyledTableCell style={{ width: "15%" }}>
                    ...
                    <button className="inactive-button">
                      <div className="inactive">Error</div>
                    </button>
                  </StyledTableCell>
                  <StyledTableCell style={{ width: "10%" }}>
                    <div
